...
CREATE SCHEMA IF NOT EXISTS WALMART_EDW;

------DIMENSION TABLES
CREATE OR REPLACE TABLE WALMART_EDW.product_dim
(	
	prod_key	Integer,
...
CREATE OR REPLACE TABLE WALMART_EDW.store_dim
(
	store_key	INTEGER,
...
CREATE OR REPLACE TABLE WALMART_EDW.calendar_dim
(	
...
-------FACT TABLES
CREATE OR REPLACE TABLE WALMART_EDW.sales_inv_store_dy
(	
CAL_DT	date,
STORE_KEY	integer,
PROD_KEY	integer,
...
CREATE OR REPLACE TABLE WALMART_EDW.sales_inv_store_wk
(	
YR_NUM	integer,
WK_NUM	integer,
STORE_KEY integer,
